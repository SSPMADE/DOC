var list = {
	...
	"About": {
		"Ssentongo Simon Peter": [
			[ "Introduction", "manual/SSP001JS/Who-is-SSP" ],
			[ "SSP OS Project", "manual/SSPOSF/sspos" ],
			[ "SSP AI Project", "manual/SSP001AI/sspai0" ]
		]
		},

	"Artificial Inteligence": {
		"Machine Learning": [
			[ "ML Introduction", "manual/SSP001AI/ML-Introduction" ],
			[ "ML and AI", "manual/SSP001AI/ML-and-AI" ],
			[ "ML Languages", "manual/SSP001AI/ML-Languages" ],
			[ "ML JavaScript", "manual/SSP001AI/ML-JavaScript" ],
			[ "ML Examples", "manual/SSP001AI/ML-Examples" ],
			[ "ML Linear Graphs", "manual/SSP001AI/ML-Linear-Graphs" ],
			[ "ML Scatter Plots", "manual/SSP001AI/ML-Scatter-Plots" ],
			[ "ML Perceptrons", "manual/SSP001AI/ML-Perceptrons" ],
			[ "ML Recognition", "manual/SSP001AI/ML-Recognition" ],
			[ "ML Training", "manual/SSP001AI/ML-Training" ],
			[ "ML Testing", "manual/SSP001AI/ML-Testing" ],
			[ "ML Learning", "manual/SSP001AI/ML-Learning" ],
			[ "ML Terminology", "manual/SSP001AI/ML-Terminology" ],
			[ "ML Data", "manual/SSP001AI/ML-Data" ],
			[ "ML Clustering", "manual/SSP001AI/ML-Clustering" ],
			[ "ML Regressions", "manual/SSP001AI/ML-Regressions" ],
			[ "ML Deep Learning", "manual/SSP001AI/ML-Deep-Learning" ],
			[ "ML Brain js", "manual/SSP001AI/ML-Brain-js" ]
		]
		},
	...
	"WEB SITE": {
		...
		"CSS3": [
			...
			[ "Import css", "manual/SSP001CSS3/Import-css" ],
		...
		"JS EXAMPLES": [
			...
			[ "simple calendar", "manual/SSP001JS/simple-calendar" ],
			...
			[ "Execute win Apps", "manual/SSP001JS/Execute-win-Apps"],
	...
	"Other": {
		...
		"SSP CORPORATE": [
			[ "Website Template", "manual/SSP001CORPORATE/index" ]
		]
		}
