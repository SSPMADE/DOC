; ------------------------------------------------------------------
; File manager can: copy, delete and rename files
; ------------------------------------------------------------------


	BITS 16
	%INCLUDE "SSPOSI/2Sources/SSPOSFloppy/apps/sspdev.asm"
	ORG 32768


	; This is the point used by the disk buffer in the SSPODF kernel
...
.draw_background:
	...
	mov bx, .footer_msg
	;mov cx, 00100000b
	mov cx, 00000111b		;sspedit color: blue on black
	...
	.title_msg		db 'SSPOSF File Manager', 0
