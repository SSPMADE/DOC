; ==================================================================
; Copyright (C) 2017 Ssentongo Simon Peter
;
; Based on a free boot loader by MIKEOS. It scans the FAT12
; floppy for SSPOSF.BIN (the SSPOS kernel), loads it and executes it.
...
OEMLabel		db "SSPOSFLP"	; Disk label: 8 characters long
...
VolumeLabel		db "SSPOSF     "; Volume Label: any 11 chars
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "SSPOSF  BIN"	; SSPOSF kernel filename

	disk_error	db "Disk error!", 0
	file_not_found	db "OS error!", 0
...
; END OF BOOT SECTOR AND BUFFER START
	...
	dw 0AA55h				; Boot signature 2 bytes


buffer:						; Disk buffer begins hear. (8k after this, stack starts)
